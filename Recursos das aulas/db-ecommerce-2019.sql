...
CREATE TABLE IF NOT EXISTS `db_ecommerce`.`tb_addresses` (
  ...
  INDEX `fk_addresses_persons_idx` (`idperson` ASC) ,
...
CREATE TABLE IF NOT EXISTS `db_ecommerce`.`tb_users` (
  ...
  `dtregister` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`iduser`),
  INDEX `FK_users_persons_idx` (`idperson` ASC) ,
...
CREATE TABLE IF NOT EXISTS `db_ecommerce`.`tb_carts` (
  ...
  `dtregister` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`idcart`),
  INDEX `FK_carts_users_idx` (`iduser` ASC) ,
  INDEX `fk_carts_addresses_idx` (`idaddress` ASC) ,
...
CREATE TABLE IF NOT EXISTS `db_ecommerce`.`tb_cartsproducts` (
  ...
  INDEX `FK_cartsproducts_carts_idx` (`idcart` ASC) ,
...
CREATE TABLE IF NOT EXISTS `db_ecommerce`.`tb_orders` (
  ...
  `dtregister` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`idorder`),
  INDEX `FK_orders_carts_idx` (`idcart` ASC) ,
  INDEX `FK_orders_users_idx` (`iduser` ASC) ,
  INDEX `fk_orders_ordersstatus_idx` (`idstatus` ASC) ,
...
CREATE TABLE IF NOT EXISTS `db_ecommerce`.`tb_userslogs` (
  ...
  `dtregister` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`idlog`),
  INDEX `fk_userslogs_users_idx` (`iduser` ASC) ,
